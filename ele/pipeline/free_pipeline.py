...
Stages: load → analysis → restoration → scene → pseudo-raw → export TIFF
Max long edge: 4000 px
"""
...
def run_free_pipeline(
    ...
    Returns:
        PipelineResult with exported image and metadata.
    """
    ...
    image = resize_long_edge(image, MAX_LONG_EDGE["free"])
